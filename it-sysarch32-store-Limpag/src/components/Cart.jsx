...
const Cart = ({ user }) => {
    ...
    return (
        <>
            <Navbar user={user} />
            <>
                {shoppingCart.length !== 0 && <h1 className='title'>Cart</h1>}
                <div className='cart-container'>
                    ...
                    {shoppingCart && shoppingCart.map(cart => (
                        <div className='cart-card' key={cart.ProductID}>
                            ...
                            <div className='cart-name'>{cart.ProductDescription}</div>
...
Cart.propTypes = {
    user: PropTypes.string // Assuming user is a string, adjust if necessary
}
